...
deepcopy-gen \
    ...
    kubevirt.io/api/filerestore/v1alpha1 \
    kubevirt.io/api/guestcommand/v1alpha1 \
...
client-gen --clientset-name kubevirt \
    ...
    --input core/v1,export/v1beta1,export/v1,snapshot/v1alpha1,snapshot/v1beta1,instancetype/v1beta1,pool/v1alpha1,pool/v1beta1,migrations/v1alpha1,clone/v1alpha1,clone/v1beta1,backup/v1alpha1,filerestore/v1alpha1,guestcommand/v1alpha1 \
...
(
    ...
    #include filerestore
    GOFLAGS= controller-gen crd paths=../api/filerestore/v1alpha1/

    #include guestcommand
    GOFLAGS= controller-gen crd paths=../api/guestcommand/v1alpha1/
